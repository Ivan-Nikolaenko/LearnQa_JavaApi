...
public class NegativeUserAuthExample {
    @Test
    public void testAuthUser() {
        ...
        assertTrue(headers.hasHeaderWithName("x-csrf-token"), "Response doesn't have 'x-" +
                "crf-token' header");
        assertTrue(responseGetAuth.jsonPath().getInt("user_id") > 0, "User" +
                "id shiuld be greater than 0");
    ...
    public void testNegativeAuthUser(String condition) {
        ...
        if (condition.equals("cookie")) {
            ...
            spec.cookie("x-csrf-token", cookies.get("x-csrf-token"));
        } else {
            throw new IllegalArgumentException("Shniage = " + condition);
        }
